...
namespace Demoqa.FinalProject.Tests.Helpers
{
    public static class WebDriverWaitHelper
    {
        ...
        public static IAlert WaitUntilAlertIsVisible(this IWebDriver driver, int timeout = 10)
        {
            try
            {
                var wait = new WebDriverWait(driver, TimeSpan.FromSeconds(timeout));
            ...
            {
                Console.WriteLine("Element with locator: 'alert' was not found in current context page.");
                throw;
            }
        }
    }
